 ...
 */
package com.example.android.sunshine.weatherwear.data;
...
import com.explore.archana.weatherwear.data.WeatherDbHelper;
import com.explore.archana.weatherwear.data.WeatherProvider;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://com.explore.archana.weatherwear/weather/
        String type = mContext.getContentResolver().getType(WeatherContract.WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.explore.archana.weatherwear/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
                WeatherContract.WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.explore.archana.weatherwear/weather/94074
        ...
        // content://com.explore.archana.weatherwear/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherContract.WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.explore.archana.weatherwear/weather/1419120000
        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry.CONTENT_ITEM_TYPE",
                WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.explore.archana.weatherwear/location/
        type = mContext.getContentResolver().getType(WeatherContract.LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.explore.archana.weatherwear/location
